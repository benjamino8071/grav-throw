/*
 * Enables player to pick up, hold and throw the Ball whilst in online gameplay.
 *
...
public class PlayerHoldAndThrowBallController : NetworkBehaviour
{
    [Header("References")]
    ...
    {
        if (!IsOwner || !GameManager.Instance.IsStateGamePlaying())
        {
            return;
        }
    ...
    {
        BallManager.Instance.BallPickedUp(GetComponent<NetworkObject>());
    ...
    private void Throw()
    {
        ...
        BallManager.Instance.BallThrown(forwardsDirection);
    ...
    public Transform GetPlayerBallSpawnPointTransform()
    {
