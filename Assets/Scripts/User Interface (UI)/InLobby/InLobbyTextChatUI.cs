...
/// <summary>
/// Handles functionality for the online text chat system, in the InLobby scene.
/// 
/// @author Ben Conway, with inspiration from the Vivox sample package
/// @date May 2024
/// </summary>
public class InLobbyTextChatUI : MonoBehaviour
{
    ...
    void SendMessage()
    {
        if (string.IsNullOrEmpty(MessageInputField.text) || !joinedChannel)
        {
            return;
        }
