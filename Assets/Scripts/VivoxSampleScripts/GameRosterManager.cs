...
/// <summary>
/// Manages the list of players displayed in the voice chat interface whilst the player is in a map scene.
/// 
/// @author Vivox sample package
/// @date May 2024
/// </summary>
public class GameRosterManager : MonoBehaviour
{
    ...
    {
        foreach (VivoxParticipant participant in vivoxPartsDict.Value)
        {
