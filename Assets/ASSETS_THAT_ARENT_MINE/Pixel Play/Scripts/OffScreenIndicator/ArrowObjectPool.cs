...
class ArrowObjectPool : MonoBehaviour
{
    ...
    [SerializeField] private FloatVariableSO ballMarkerSizeSO;
    ...
    {
        foreach (Indicator pooledObj in pooledObjects)
        {
            pooledObj.GetComponent<RectTransform>().sizeDelta =
                new Vector2(ballMarkerSizeSO.GetValue(), ballMarkerSizeSO.GetValue());
        }
    }
